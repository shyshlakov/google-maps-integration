...
{
    public class AdministrativeAreaLevel5Reader : IDataReader<string, Guid?>
    {
        ...
        public AdministrativeAreaLevel5Reader(BaseDbContext dbContext)
            => DbContext = dbContext;
        ...
        {
            Guid existingId = DbContext.AdministrativeAreasLevel5
