...
{
    public class AdministrativeAreaLevel4Reader : IDataReader<string, Guid?>
    {
        ...
        public AdministrativeAreaLevel4Reader(BaseDbContext dbContext)
            => DbContext = dbContext;
        ...
        {
            Guid existingId = DbContext.AdministrativeAreasLevel4
